...
let userId, token;
const randomId = 'sha512-8XkAphELsDnEGrDxUOHB3RGvXz6TeuYSGEZBOjtTtPm2lwhGBjLgOzLHB63IUWfBpNucQjND6d3AOudO+H3RWQ';
...
beforeAll(async () => {
  ...
  const user = await User.create({
    firstName: 'Zaruq',
    lastName: 'Abdul',
    email: 'olaniyizahruuhk@mail.com',
    password: hashedPassword,
    phoneNumber: '08158271503',
  });
  userId = user.userId;
